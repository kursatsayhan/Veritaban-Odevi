<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilmeYapılanIncelemeler.aspx.cs" Inherits="WEB.FilmeYapılanIncelemeler" %>
...
<body class="form">
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Height="323px" Width="1411px">
