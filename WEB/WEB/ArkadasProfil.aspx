<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArkadasProfil.aspx.cs" Inherits="WEB.ArkadasProfil" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button class=myButton ID="Button3" runat="server" Text="Anasayfa" Width="282px" OnClick="Button3_Click" />
            <br />
            <asp:Button class=myButton ID="Button5" runat="server" Text="Mesaj At" Width="282px" OnClick="Button5_Click" />
            <br />
            <asp:Button class=myButton ID="Button4" runat="server" Text="Kişi Ara" Width="282px" OnClick="Button4_Click" />
            &nbsp;&nbsp;
            <br />
            <asp:Button class=myButton ID="Button2" runat="server" Text="Arkadaş Ekle" Width="282px" OnClick="Button2_Click" />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Label" Visible="False"></asp:Label>
            <br />
            <br />
            <br />
            <asp:Button class=myButton ID="Button6" runat="server" Text="Arkadaş Çıkar" Width="282px" OnClick="Button6_Click" Visible="False" />
            <br />
            <asp:Label ID="Label8" runat="server" Text="Arkadaşlıktan Çıkartıldı..." Visible="False"></asp:Label>
            <br />
        </div>
