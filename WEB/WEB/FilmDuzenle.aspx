<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilmDuzenle.aspx.cs" Inherits="WEB.FilmDuzenle" %>
...
<body class=form style="height: 931px; width:1741px">
    <form id="form1" runat="server">
        ...
        <div class=myDiv1 style="height: 835px; width: 1156px">
            ...
            <br />
            <br />
            <asp:Label ID="Label9" runat="server" Font-Size="Large" Text="Film Seç :"></asp:Label>
            <asp:DropDownList placeholder="" CssClass="textbox2" ID="DropDownList6" runat="server" OnSelectedIndexChanged="DropDownList6_SelectedIndexChanged" DataMember="DefaultView">
                
            </asp:DropDownList>
            &nbsp;
            <asp:Button ID="Button4" runat="server" Text="Seçilen Film Datalarını Ekle" Width="188px" OnClick="Button4_Click" />
            <br />
            <asp:Label ID="Label1" runat="server" Font-Size="Large" Text="Film Adı :"></asp:Label>
            <asp:TextBox placeholder="" class="textbox" ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Label2" runat="server" Font-Size="Large" Text="Yonetmen :"></asp:Label>
            <asp:DropDownList placeholder="" CssClass="textbox2" ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" DataTextField="yonetmen" DataValueField="yonetmen">
                
            </asp:DropDownList>
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Font-Size="Large" Text="Kategori :"></asp:Label>
            <asp:DropDownList placeholder="" CssClass="textbox2" ID="DropDownList5" runat="server" DataTextField="kategori" DataValueField="kategori">
                
            </asp:DropDownList>
            <br />
            <br />
            <asp:Label ID="Label3" runat="server" Font-Size="Large" Text="Senarist :"></asp:Label>
            <asp:DropDownList placeholder="" CssClass="textbox2" ID="DropDownList2" runat="server" DataTextField="senarist" DataValueField="senarist">
                
            </asp:DropDownList>
            <br />
            <br />
            <asp:Label ID="Label4" runat="server" Font-Size="Large" Text="Dil :"></asp:Label>
            <asp:DropDownList placeholder="" CssClass="textbox2" ID="DropDownList3" runat="server" DataTextField="dil" DataValueField="dil">
                
            </asp:DropDownList>
            <br />
            <br />
            <asp:Label ID="Label5" runat="server" Font-Size="Large" Text="Odul :"></asp:Label>
            <asp:DropDownList placeholder="Cinsiyet..." CssClass="textbox2" ID="DropDownList4" runat="server" DataTextField="odul" DataValueField="odul">
